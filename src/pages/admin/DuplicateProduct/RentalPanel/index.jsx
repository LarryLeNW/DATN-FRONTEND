...
function RentalPanel({
    ...
    const [selectedRentalVariants, setSelectedRentalVariants] = useState([]);
    ...
    useEffect(() => {
        setVariants((prev) => {
            ...
            formatVariants.forEach((v, index) => {
                if (v.price) {
        ...
        const selectedVariants = variants
            .map((v, index) => (v.canBeRented ? index : -1))
            .filter((index) => index !== -1);
        setSelectedRentalVariants(selectedVariants);
    }, []);
    ...
    const onRowSelectionChange = (newSelectedRowKeys) => {
        setSelectedRentalVariants(newSelectedRowKeys);
    ...
    const rowSelection = {
        selectedRowKeys: selectedRentalVariants,
