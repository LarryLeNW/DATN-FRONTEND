...
import { getCategoryBlog } from "apis/categoryBlog";
...
function BlogForm({ closeModal, fetchData, blogCurrent }) {
    ...
    const handleUpdate = async (data) => {
        ...
        try {
            ...
            notification.error({
                message: `${blogCurrent?.id ? "Cập nhật" : "Tạo"} không thành công: ${error.message}`,
            });
        } finally {
            dispatch(changeLoading());
        }
        ...
        <div className="flex flex-col justify-center items-center">
            ...
            >
                ...
                <div className="flex gap-4 px-2 py-4 border rounded border-black">
                    <label htmlFor="category" className="text-lg font-bold text-nowrap text-black">
                        CategoryBlog:
                    </label>
                    <Select
                        showSearch
