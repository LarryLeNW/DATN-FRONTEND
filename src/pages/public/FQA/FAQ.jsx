...
function FAQ() {
  ...
  <div class="aspect-w-16 aspect-h-9 w-full max-w-6xl bg-white shadow-lg rounded-lg overflow-hidden">
    <div class="p-6">
    <h1 className="text-3xl font-extrabold mb-6 font-[sans-serif] inline-flex items-center space-x-2">
      <span>HỎI ĐÁP</span>
      ...
      <div class="grid sm:grid-cols-2 items-start gap-15 p-4   mx-auto max-w-7xl bg-white font-[sans-serif]">
            <div>
                ...
                <div class="mt-12">
                    <h2 class="text-gray-800 text-base font-bold">Xã hội</h2>
            ...
            <form class="ml-auto space-y-4">
              ...
              <button
      type="button"
      className="flex items-center justify-center text-white bg-blue-500 hover:bg-blue-600 tracking-wide rounded-lg text-sm px-6 py-2 w-full !mt-3 font-extrabold shadow-lg transition duration-200 ease-in-out transform hover:scale-105"
    >
  ...
  <div class="space-y-8 max-w-4xl">
    <div class="flex items-start">
      ...
      <div class="ml-4">
        <h3 class="text-lg font-semibold text-[#333]">Làm thế nào để chọn nền tảng thương mại điện tử phù hợp cho cửa hàng thời trang của tôi?</h3>
        <p class="text-sm text-[#333] mt-4">Để chọn nền tảng thương mại điện tử phù hợp, bạn nên xem xét các yếu tố như tính năng, chi phí, khả năng tùy chỉnh, hỗ trợ khách hàng và tính dễ sử dụng. Một số nền tảng phổ biến cho ngành thời trang bao gồm Shopify, WooCommerce và BigCommerce. </p>
      </div>
    </div>
    <div class="flex items-start">
      <div class="flex-shrink-0">
      ...
      <div class="ml-4">
        <h3 class="text-lg font-semibold text-[#333]">Làm thế nào để tăng cường trải nghiệm mua sắm trực tuyến cho khách hàng?</h3>
