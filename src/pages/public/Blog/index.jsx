  ...
  return (
    <div className="bg-gray-100 md:px-10 px-4 py-12 font-[sans-serif]">
      <div className="max-w-5xl max-lg:max-w-3xl max-sm:max-w-sm mx-auto">
        <h2 className="text-3xl text-gray-800 mb-8">Tin tức hot về sản phẩm</h2>
          ...
          {blogs.map((post) => {
            ...
            return (
              <div key={post.id} className="bg-white rounded overflow-hidden">
                <img src={FirstImage} alt={post.title} className="w-full h-52 object-cover" />
                <div className="p-6">
                  ...
                  <Link to={`/blogs/${post.blogId}`} className="mt-4 inline-block px-4 py-2 rounded tracking-wider bg-orange-500 hover:bg-orange-600 text-white text-[13px]">
                    Read More
                  </Link>
                </div>
              </div>
