            ...
            <div class="grid items-start grid-cols-1 lg:grid-cols-2 gap-6 max-lg:gap-12">
                ...
                <div class="w-full lg:sticky top-0">
                    <div class="flex justify-center gap-4 mb-4">
                        <img src="https://readymadeui.com/images/product1.webp" alt="Product1" 
                            class="w-16 sm:w-20 cursor-pointer rounded-md outline object-cover" />
                        <img src="https://readymadeui.com/images/product6.webp" alt="Product2" 
                            class="w-16 sm:w-20 cursor-pointer rounded-md object-cover" />
                        <img src="https://readymadeui.com/images/product7.webp" alt="Product3" 
                            class="w-16 sm:w-20 cursor-pointer rounded-md object-cover" />
                        <img src="https://readymadeui.com/images/product3.webp" alt="Product4" 
                            class="w-16 sm:w-20 cursor-pointer rounded-md object-cover" />
                    </div>
                    <div class="flex justify-center w-full">
                        <img src="https://readymadeui.com/images/product2.webp" alt="Product" 
                            class="w-full sm:w-4/5 mx-auto rounded-md object-cover" />
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="flex space-x-2 mt-4">
                        <svg class="w-5 fill-blue-600 hover:fill-orange-500 transition duration-300 ease-in-out" viewBox="0 0 14 13" fill="none"
                        ...
                        <svg class="w-5 fill-[#CED5D8] hover:fill-orange-500 transition duration-300 ease-in-out" viewBox="0 0 14 13" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <path
                                d="M7 0L9.4687 3.60213L13.6574 4.83688L10.9944 8.29787L11.1145 12.6631L7 11.2L2.8855 12.6631L3.00556 8.29787L0.342604 4.83688L4.5313 3.60213L7 0Z" />
                        </svg>
                        ...
                        <div className="mt-8">
                            ...
                            <div className="flex flex-wrap gap-4 mt-4">
                                <button type="button" className="w-10 h-10 border-2 hover:border-blue-600 font-semibold text-sm rounded-full flex items-center justify-center shrink-0">S</button>
                                <button type="button" className="w-10 h-10 border-2 hover:border-blue-600 border-blue-600 font-semibold text-sm rounded-full flex items-center justify-center shrink-0">M</button>
                                <button type="button" className="w-10 h-10 border-2 hover:border-blue-600 font-semibold text-sm rounded-full flex items-center justify-center shrink-0">L</button>
                        ...
                        <div className="mt-8">
                            ...
                            <div className="flex flex-wrap gap-4 mt-4">
                                <button type="button" className="w-10 h-10 border-2 hover:border-blue-600 font-semibold text-sm rounded-full flex items-center justify-center shrink-0" style={{ backgroundColor: "#FF0000", color: "white" }}>Đỏ</button>
                                <button type="button" className="w-10 h-10 border-2 hover:border-blue-600 border-blue-600 font-semibold text-sm rounded-full flex items-center justify-center shrink-0" style={{ backgroundColor: "#0080FF", color: "white" }}>Xanh</button>
                                <button type="button" className="w-10 h-10 border-2 hover:border-blue-600 font-semibold text-sm rounded-full flex items-center justify-center shrink-0" style={{ backgroundColor: "#800080", color: "white" }}>Tím</button>
                                <button type="button" className="w-10 h-10 border-2 hover:border-blue-600 font-semibold text-sm rounded-full flex items-center justify-center shrink-0" style={{ backgroundColor: "#FFD700", color: "black" }}>Vàng</button>
                                <button type="button" className="w-10 h-10 border-2 hover:border-blue-600 font-semibold text-sm rounded-full flex items-center justify-center shrink-0" style={{ backgroundColor: "#FFD700", color: "black" }}>Vàng</button>
                            </div>
                            <div className="flex flex-wrap gap-4 mt-4">
                                <button type="button" className="w-10 h-10 border-2 hover:border-blue-600 font-semibold text-sm rounded-full flex items-center justify-center shrink-0" style={{ backgroundColor: "#FF0000", color: "white" }}>Đỏ</button>
