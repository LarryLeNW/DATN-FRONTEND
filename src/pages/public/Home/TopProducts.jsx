            ...
            <div className="container-fluid grid grid-cols-5 gap-x-4">
                ...
                <div className="relative">
                    <div className="sticky top-[50px] bg-gray-200 p-4 shadow-md w-55">
                        <h2 className="text-xl font-semibold mb-4 text-center">Danh mục</h2>
                                ...
                                >
                                    ...
                                    <div>
                                        <h3 className="text-lg font-extrabold text-gray-800">
                                            <TrunCateText text={product.name} maxLength={55}/>
                                        </h3>
                                            ...
                                            <span
                                                ...
                                                dangerouslySetInnerHTML={{
                                                    __html: DOMPurify.sanitize(
                                                        TrunCateText({ text: product?.description, maxLength: 35 })
                                                    ),
                                                }}
                                            ></span>                                        </p>
