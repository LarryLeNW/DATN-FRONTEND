  ...
  <div className="flex flex-col md:flex-row gap-8">
    ...
    <div className="flex-none w-full md:w-1/2 bg-gradient-to-r from-orange-400 to-gray-300  p-6 rounded-lg relative overflow-hidden shadow-xl">
      ...
      <div className="relative z-10 text-white">
        <div className="text-red-600 font-bold text-xl mb-2">Bùng Nổ Sale Giữa Tháng - Mua Ngay, Đừng Bỏ Lỡ!</div>
        <div className="text-white font-semibold text-base mb-4">Còn 2 Ngày</div>
        
        <h2 className="text-3xl font-extrabold text-white mb-4 transition duration-300 transform text-white-400">Siêu Ưu Đãi Giảm Giá Đến 70% - Nâng Tầm Phong Cách!</h2>
        <div className="text-white font-semibold text-lg mb-4">Đặc biệt: Giảm 50% toàn bộ sản phẩm từ ngày 7/7 đến 21/7. Không thể bỏ qua!</div>
