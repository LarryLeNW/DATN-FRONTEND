...
const Footer = () => {
    return (
        <div style={BannerImg} className="text-white mt-20">
            <div>
                <div data-aos="zoom-in" className="grid md:grid-cols-3 pb-6 pt-4">
                    {/* company details */}
                    <div className="py-4 px-4">
                        ...
                        <p className="text-sm">
                            Chào mừng đến với Fashion Shop - điểm đến lý tưởng cho những tín đồ yêu thích thời trang! Tại đây,
                            chúng tôi cung cấp một bộ sưu tập đa dạng các sản phẩm thời trang từ trang phục, giày dép đến phụ kiện,
                            phù hợp với mọi phong cách và dịp.
                        </p>
                    </div>
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-3 col-span-2 md:pl-6">
                        <div>
                            <div className="py-4 px-4">
                                <h1 className="sm:text-lg text-md font-bold sm:text-left text-justify mb-2">Mục Lục</h1>
                        ...
                        <div className="flex flex-col justify-center items-start mt-4 px-4">
                            ...
                            <div className="mt-4">
                                <div className="flex items-center gap-2">
                                    <FaLocationArrow />
                                    <p className="text-sm">Liên chiểu, TP Đà Nẵng</p>
                                </div>
